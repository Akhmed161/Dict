pattern = {
    ...
    'сап': ['sар', 'sap'],
    'рдб': ['pdb', 'rdb'],
    'рдп': ['Rdp', 'рдиди', 'Remote Desktop Protocol', 'Remote Desktop', 'протокол удалённого рабочего стола', 'протокол удаленного рабочего стола', 'удаленный рабочий стол'],
    'роботизация': ['rpa', 'рпа'],
    ...
    'грейд': ['pl'],
    '182 н': ['182н','182-н','н-182','н182', 'справка 182'],
    ...
    'добровольное медицинское страхование': ['добровольное мед(\.)? страхование', 'дмс', 'мед(\.)? страхование', 'мед(\.)?страхование', 'добровольное страхование'],
    ...
    'план закупок': ['пз'],
    'долг': ['задолжность', 'за должность', 'задолженость', 'задолженность'],
    ...
    #в основном общие
    'сим': ['sim-карт(.)?', 'сим карт\w*?', 'sim', 'симок', 'sim карт(.)?', 'сим-карт(.)?', 'симк\w*', 'симкарт(.)?'],
    ...
    'пока': ['адьос', 'bye', 'бай', 'покедова', 'покеда', 'аревуар', 'арревуар', 'бай-бай', 'гудбай', 'чау', 'чао', 'пака', 'до связи', 'до завтра', 'до свядания', 'досвиданья', 'досвидания', 'досвилание', 'до саидания', 'бай-бай', 'бот пока', 'поки', 'счастливо', 'спасибо.всего доброго', 'спасибо,всего доброго', 'спасибовсего доброго', 'бывай', 'поуа', 'прощай', 'прощай бот', 'Бот прощай'],
    ...
    'почему': ['почиму', 'почемуттак', 'пояему', 'в связи с чем', 'связи с чем', 'с чем связан(.)?', 'с чем это связан(.)?', 'с чем это может быть связан(.)?', 'почечу'],
    'вы': ['ви'],
    'кино': ['кинчик'],
