pattern = {
    ...
    'мнп': ['mnp'],
    'теле2': ['tele-2', 'tele2', 'теле 2', 'tele 2', 'теледва', 'теле два', 'теле', 'т2 мобайл', 'т2-мобайл', 'ооо т2 мобайл', 'ооо т2 мобаил'],
    ...
    'почему': ['пачему', 'пачиму', 'почиму', 'почемуттак', 'пояему', 'в связи с чем', 'связи с чем', 'с чем связан(.)?', 'с чем это связан(.)?', 'с чем это может быть связан(.)?', 'почечу', 'по чему', 'какого хрена бл'],
    'вы': ['ви'],
    'кино': ['кинчик'],
