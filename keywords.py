pattern = {
    ...
    'есим': ['esim', 'е-сим', 'easim', 'e сим', 'е сим', 'е -сим', 'e-sim', 'esim-карт(\w)?', 'есим-карт(\w)?', 'esim карт(\w)?', 'есим карт(\w)?', 'виртуальн\w* sim', 'виртуальн\w* сим\w*', 'электрон\w* сим\w*', 'есимк(\w)?', 'вирт сим', 'esum(\w)?'],
    'нано': ['nano'],
