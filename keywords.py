pattern = {
    ...
    'удаленный доступ': ['удалёнк(\w)?', 'удаленк(\w)?', 'удалён\w* доступ(\w)?', 'удален\w* доступ(\w)?', 'удален\w* работа', 'удалён\w* работа', 'работа из дома', 'работать удаленно', 'работать удалённо', 'работать на удалёнке', 'работать на удаленке'],
    ...
    'нано': ['nano'],
    'гигабайт': ['гб', 'gb', 'гиг(\w)?', 'гигов', 'гигами', 'гбайт\w*', 'гибогайт(\w)?', 'кигобайт(\w)?', 'гигабвйт(\w)?', 'гигобацт\w*', 'гигаб'],
    'мегабайт': ['мегабаит(\w)?', 'мега байт(\w)?', 'mb', 'мб', 'мгб'],
    ...
    'обещанный платеж': ['обещен\w* платеж(\w)?', 'обеден\w* платеж(\w)?', 'обешен\w* платеж(\w)?', 'обешен\w* платёж', 'обещаны(\w)? платеж(\w)?', 'обещаны(\w)? платёж(\w)?', 'обнщаны(\w)? платеж(\w)?', 'оп', 'ебещан\w* платеж(\w)?', 'общен\w* платёж', 'обещин\w* платёж', 'обешан\w* платёж', 'обещае\w* платеж(\w)?'],
    'долг': ['долк', 'долн'],
    'другой': ['др.'],
    'исходящий': ['исх(\.)?'],
    'входящий': ['вх(\.)?'],
    ...
    'блэк': ['блейк', 'Black'],
    'стоимость': ['Стомость',],
    'абонентская плата': ['АП', 'абон(\.)?плата', 'абон(\w)? плат(\w)?', 'абанентски рлата', 'анон плат(\w)?'],
    'разблокируйте': ['Расблоктруйте', 'Black'],
    'сколько': ['скок(\w)?', 'сколко'],
    'миа': ['мия', 'мии'],
    'подключить': ['потклучит(\w)?', 'потключить', 'подклучит(\w)?', 'падклучит(\w)?'],
    'подключен': ['потключен'],
    'подключил': ['потключил'],
    'отключить': ['атклечить'],
