pattern = {
    ...
    'тарифы': ['тарифв'],
    'говно': ['гавно', 'дермо'],
    'интернет': ['инет\w*', 'internet', 'интырнкт', 'тньернет', 'инэт', 'инт-т', 'интеренет', 'интирнет', 'ин т', 'ин-т', 'интерне', 'иньернет(\w)?', 'иньрентет(\w)?', 'интернкт(\w)?', 'интенет(\w)?', 'иниернет(\w)?', 'интнрнет(\w)?', 'интернер', 'энтернет', 'интерет(\w)?', 'ентернет(\w)?', 'интетнет(\w)?', 'инернет(\w)?', 'интэрнэт(\w)?', 'интрнт',],
