pattern = {
    ...
    'элит': ['elite'],
    'тариф': ['ТП', 'тараф(\w)?', 'тапиф', 'ториф', 'таррив(\w)?', 'тарив(\w)?', 'тариы', 'твриф', 'тартф', 'тприф', 'таариф', 'трариф', 'тармфы', 'тарий', 'тармф(\w)?', 'таиифы', 'tariff'],
    'тарифы': ['тарифв', 'трифы', 'тарифэ'],
