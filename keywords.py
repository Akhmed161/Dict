pattern = {
    ...
    'рестор': ['Re:Store'],
    'стор': ['stor(\w)?'],
    'вотсап': ['вац ап', 'вацап', 'ватсап(\w)?', 'вассап', 'ватцап(\w)?', 'ватс ап', 'whatsapp', 'whats app', 'whassup', 'whatsup', 'what`s app', 'воцап', 'ваттсап', 'вотцап(\w)?', 'ват сап(\w)?'],
    'вк': ['vkontakte', 'vk', 'vc'],
    'комбо': ['combo', 'kombo'],
    'вк комбо': ['вккомбо'],
    ...
    'опера': ['opera'],
    'мини': ['mini'],
    'тарифт2': ['Тариф мой Теле2', 'Тариф мой Теле 2', 'Тариф мой Tele2', 'Тариф мой Tele 2', 'Тариф мой Т2', 'Тариф мой T2', 'ТП мой Теле2', 'ТП мой Теле 2', 'ТП мой Tele2', 'ТП мой Tele 2', 'ТП мой Т2', 'ТП мой T2'],
