pattern = {
    ...
    'обещанный платеж': ['обещен\w* платеж(\w)?', 'обеден\w* платеж(\w)?', 'обешен\w* платеж(\w)?', 'обешен\w* платёж', 'обещаны(\w)? платеж(\w)?', 'обещанаия платёж', 'обещаны(\w)? платёж(\w)?', 'обнщаны(\w)? платеж(\w)?', 'оп', 'ебещан\w* платеж(\w)?', 'общен\w* платёж', 'обещин\w* платёж', 'обешан\w* платёж', 'обещае\w* платеж(\w)?', 'обещ(\.)? платеж(\w)?', 'обещ(\.)? платёж', 'обещание платёж'],
    'долг': ['долк', 'долн'],
    'другой': ['др(\.)'],
    'исходящий': ['исх(\.)?'],
    'входящий': ['вх(\.)?'],
