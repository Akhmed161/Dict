pattern = {
    ...
    'инвойс': ['invoic\w*', 'invoic(\w)? clients', 'invoic(\w)? admin', 'invoic(\w)? inventory', 'inventory', 'инвойс админ', 'инвойс инвентори', 'инвойс клиент', 'invoice_clients'],
    ...
    'восстановить': ['востоновит(\w)?', 'восстиановит(\w)?', 'восстоновт(\w)?', 'восстоновит(\w)?', 'восставновит(\w)?', 'восстаовит(\w)?', 'восстанвоит(\w)?', 'восстановат(\w)?', 'восстанвит(\w)?', 'востоноваит(\w)?', 'востановит(\w)?', 'восстановитбь', 'востоноваит', 'востановт(\w)?', 'djcnfyjdbnm', 'djjcnfyjdbnm', 'djccnfyjdbnm'],
    'восстановление': ['восстанорвлени(\w)?', 'востановлерни(\w)?', 'восстанвлени(\w)?', 'воссатновлени(\w)?', 'восстанволени(\w)?', 'востановдлени(\w)?', 'востоновлени(\w)?', 'восстанволни(\w)?', 'восставнолни(\w)?', 'вовтановлени(\w)?', 'воссатвнолени(\w)?', 'востанови', 'востановка', 'востанов', 'востанович', 'ввосстанов', 'востановл', 'восстановле', 'восс тановить', 'восстанолвени(\w)?', 'восстаногвлени(\w)?', 'djcnfyjdbnmyjvth', 'djcnfyjdktybt', 'djcnfyjdktybt', 'djcnjyjdktybt', 'djcnfyjdktybt', 'djccnfyjdktybt', 'djccnfyjdktybgt'],
    'почините': ['прчините'],
