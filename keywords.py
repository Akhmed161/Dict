pattern = {
    ...
    'нано': ['nano'],
    'гигабайт': ['гб(\w)?', 'gb', 'гиг(\w)?', 'гигов', 'гигами', 'гбайт\w*', 'гибогайт(\w)?', 'кигобайт(\w)?', 'гигабвйт(\w)?', 'гигобацт\w*', 'гигаб', 'гега', 'гбт(\w)?'],
    ...
    'пак': ['puk-код(\w)?', 'puck', 'пук-код(\w)?', 'puk код(\w)?', 'puc код(\w)?', 'пак-код(\w)?', 'рuk код(\w)?', 'паккод(\w)?', 'пуккод(\w)?', 'puk2', 'puk-2', 'пак2', 'пак-2', 'пак2 код', 'puk', 'рак код', 'пук код', 'пака', 'пакы'],
