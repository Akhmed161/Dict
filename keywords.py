pattern = {
    ...
    'нано': ['nano'],
    'гигабайт': ['гб(\w)?', 'gb', 'гиг(\w)?', 'гигов', 'гигами', 'гбайт\w*', 'гибогайт(\w)?', 'кигобайт(\w)?', 'гигабвйт(\w)?', 'гегабвйт(\w)?', 'гегабайт(\w)?', 'гигобацт\w*', 'гигаб\w*', 'гега\w*', 'гбт(\w)?', 'гигобайт\w*', 'гигобайт\w*', 'гегобайт\w*', 'ггб', 'гигоьайт(\w)?', 'гигаюайт(\w)?', 'гег\w*', 'гагаб\w*', 'гибайт\w*', 'гишабайт(\w)?'],
    'мегабайт': ['мегабаит(\w)?', 'мега байт(\w)?', 'mb', 'мб', 'мгб', 'мбат', 'мигобайт\w*', 'мегобайт\w*'],
    'терабайт': ['тб'],
