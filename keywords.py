pattern = {
    ...
    'симка': ['sim-карт\w*', 'сим карт\w*', 'sim', 'симок', 'sim карт(\w)?', 'сим-карт(\w)?', 'сим', 'симкарт(\w)?', 'simкарт(\w)?', 'сим к(\w)?', 'симкврт(\w)?', 'смкарт(\w)?', 'см карт(\w)?', 'семкар\w*', 'симкорта'],
    'есим': ['esim', 'е-сим', 'easim', 'e сим', 'е сим', 'е -сим', 'e-sim', 'esim-карт(\w)?', 'есим-карт(\w)?', 'esim карт(\w)?', 'есим карт(\w)?', 'виртуальн\w* sim', 'виртуальн\w* сим\w*', 'электрон\w* сим\w*', 'есимк(\w)?', 'вирт сим', 'esum(\w)?', 'к сим'],
    'нано': ['nano'],
