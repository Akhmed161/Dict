pattern = {
    ...
    'кончился': ['кончилца'],
    'нельзя перевести': ['не могу перевести', 'перевести не могу', 'не могу перенести', 'не могу вывести', 'не могу выполнить перевод', 'не могу сделать перевод', 'не могу отправить', 'не могу осуществить перевод', 'не могу сделать перевод', 'не могу перекинуть', 'не могу перечислить', 'не могу отправлять', 'не могу совершить'],
