pattern = {
    ...
    'восстановление': ['восстанорвлени(\w)?', 'востановлерни(\w)?', 'воссатновлени(\w)?', 'восстанволени(\w)?', 'востановдлени(\w)?', 'востоновлени(\w)?', 'восстанволни(\w)?', 'восставнолни(\w)?', 'вовтановлени(\w)?', 'воссатвнолени(\w)?', 'востанови', 'востановка', 'востанов', 'востанович', 'ввосстанов', 'востановл', 'восстановле', 'восс тановить', 'восстанолвени(\w)?', 'восстаногвлени(\w)?'],
    'почините': ['прчините'],
