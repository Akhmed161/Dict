pattern = {
    ...
    'пак': ['puk-код(\w)?', 'puck', 'puk kod(\w)?', 'пук-код(\w)?', 'пук кот(\w)?', 'puk код(\w)?', 'puc код(\w)?', 'пак-код(\w)?', 'рuk код(\w)?', 'паккод(\w)?', 'пуккод(\w)?', 'puk2', 'puk-2', 'пак2', 'пак-2', 'пак2 код', 'puk', 'рак код', 'пук код', 'puc', 'puk кол', 'puk kod'],
