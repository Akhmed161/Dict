pattern = {
    ...
    'инвойс': ['invoic\w*', 'invoice_clients', 'in@voice(\w)?'],
    'клиент': ['clients(\w)?'],
    ...
    'труконф': ['trueconf'],
    'сервисдеск': ['sd', 'servicedesk(\w)?', 'sd.corp.tele2.ru', 'bpmonline service desk', 'bpmonline', 'bpm(\w)?', 'бпм(\w)?', 'bpm-servicedesk', 'bpm servicedesk', 'service desk', 'servic desk', 'servicdesk(\w)?', 'бпм servicedesk', 'бпм-servicedesk', 'бпм-сервисдеск', 'бпм сервисдеск'],
    'ср': ['sr'],
    'рсчс': ['rschs'],
    ...
    'нано': ['nano'],
    'гигабайт': ['гб(\w)?', 'gb', 'гиг(\w)?', 'гигов', 'гигами', 'гбайт\w*', 'гибогайт(\w)?', 'кигобайт(\w)?', 'гигабвйт(\w)?', 'гегабвйт(\w)?', 'гегабайт(\w)?', 'гигобацт\w*', 'гигаб\w*', 'гега\w*', 'гбт(\w)?', 'гигоб\w*', 'гегобайт\w*', 'ггб', 'гигоьайт(\w)?', 'гигаюайт(\w)?', 'гег\w*', 'гагаб\w*', 'гибайт\w*', 'гишабайт(\w)?'],
