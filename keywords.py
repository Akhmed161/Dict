pattern = {
    ...
    'инвойс': ['invoic\w*', 'invoic(\w)?', 'invoic(\w)?', 'invoice_clients'],
    'клиент': ['clients'],
    'инвентори': ['inventory'],
    'админ': ['admin'],
    ...
    'кьюар': ['qr', 'qr-код', 'qrкод', 'кью ар', 'кью', 'куар', 'кьюар-код'],
    ...
    'скиллбокс': ['skilbox', 'skillbox', 'skilboxe', 'skilboks', 'skilbocs'],
    'скилл': ['skill', 'skil'],
    ...
    'апсейлер': ['apseller', 'apseler', 'appseler', 'appseller', 'апселер', 'апсселер', 'эпсселер', 'эпселлер', 'апселлер'],
