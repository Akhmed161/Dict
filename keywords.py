pattern = {
    ...
    'восстановление': ['восстанорвлени(\w)?', 'востановлерни(\w)?', 'воссатновлени(\w)?', 'восстанволени(\w)?', 'востановдлени(\w)?', 'востоновлени(\w)?', 'восстанволни(\w)?', 'восставнолни(\w)?', 'вовтановлени(\w)?', 'воссатвнолени(\w)?', 'Востанови', 'востановка', 'востанов', 'ВОСТАНОВИЧ', 'ввосстанов', 'востановл', 'восстановле'],
    'почините': ['прчините'],
