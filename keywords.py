pattern = {
    ...
    'корректировка': ['корректировака', 'корректива', 'коррективка', 'корректовка', 'короктеровка', 'кориктивировка', 'корокреровка', 'корокеровка', 'кориктеровка', 'котирровка'],
