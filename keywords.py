pattern = {
    ...
    'труконф': ['trueconf'],
    'сервисдеск': ['sd', 'servicedesk(\w)?', 'sd.corp.tele2.ru', 'врм', 'bpmonline service desk', 'bpmonline', 'bpm(\w)?', 'бпм(\w)?', 'bpm-servicedesk', 'bpm servicedesk', 'service desk', 'servic desk', 'servicdesk(\w)?', 'бпм servicedesk', 'бпм-servicedesk', 'бпм-сервисдеск', 'бпм сервисдеск'],
    'ср': ['sr'],
    'рсчс': ['rschs'],
    ...
    'микс': ['mix\w*', 'miks\w*', 'мих\w*', 'mux\w*', 'миск\w*'],
    'макс': ['max', 'maxx'],
    'эко': ['eco', 'eko'],
    ...
    'обещанный платеж': ['обещен\w* платеж(\w)?', 'обеден\w* платеж(\w)?', 'обешен\w* платеж\w*', 'обешен\w* платёж\w*', 'обещаны(\w)? платеж(\w)?', 'обещанаия платёж', 'обещаны(\w)? платёж(\w)?', 'обнщаны(\w)? платеж(\w)?', 'ебещан\w* платеж(\w)?', 'общен\w* платёж', 'обещин\w* платёж', 'обешан\w* платёж', 'обещае\w* платеж(\w)?', 'обещ(\.)? платеж(\w)?', 'обещ(\.)? платёж', 'обещание платёж', 'обещание платеж(\w)?', 'абешен\w* платеж(\w)?', 'обещенк(\w)?'],
    'долг': ['долк', 'долн'],
    'другой': ['др(\.)'],
    'исходящий': ['исх(\.)?'],
    'входящий': ['вх(\.)?'],
