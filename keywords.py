pattern = {
    ...
    'обещанный платеж': ['обещенны(\w)? платеж(\w)?', 'обеденны(\w)? платеж(\w)?', 'обешенны(\w)? платеж(\w)?', 'обещаны(\w)? платеж(\w)?', 'обнщаны(\w)? платеж(\w)?'],
    'другой': ['др.'],
    'исходящий': ['исх(\.)?'],
    'входящий': ['вх(\.)?'],
    ...
    'платеж': ['платяж(\w)?','платкж(\w)?', 'платед(\w)?', 'лптеж'],
    'положил': ['полоижил'],
    'рубли': ['руб(\.)?', '₽', 'р'],
