pattern = {
    ...
    'кьюар': ['qr', 'qr-код', 'qrкод', 'кью ар', 'кью', 'куар'],
    ...
    'левелап': ['левел ап', 'level up', 'levelup', 'level-up', 'Skill cup', 'lvlup'],
    ...
    'есим': ['esim', 'е-сим', 'easim', 'e сим', 'е сим', 'e-sim', 'esim-карт(\w)?', 'есим-карт(\w)?', 'esim карт(\w)?', 'есим карт(\w)?', 'виртуальн\w* sim', 'виртуальн\w* сим\w*', 'электрон\w* сим\w*', 'есимк(\w)?', 'вирт сим'],
    'нано': ['nano'],
    ...
    'рестор': ['re:store'],
    'стор': ['stor(\w)?'],
    'вотсап': ['вац ап', 'вацап', 'ватсап(\w)?', 'вассап', 'ватцап(\w)?', 'ватс ап', 'whatsapp', 'whats app', 'whassup', 'whatsup', 'what`s app', 'воцап', 'ватсап', 'ваcсап', 'ваттсап', 'вотцап(\w)?', 'ват сап(\w)?'],
    'вк': ['vkontakte', 'vk', 'vc'],
    'комбо': ['combo', 'kombo'],
    'вк комбо': ['вккомбо'],
    ...
    'ютуб': ['you tub(\w)?', 'youtub(\w)?', 'ютюб', 'ютб'],
    ...
    'мнп': ['mnp'],
    'теле2': ['tele-2', 'tele2', 'теле 2', 'tele 2', 'теледва', 'теле два', 'теле', 'телле 2', 'телле2', 'т2', 'тле 2', 'телет2', 'еле2', 'телет2'],
    ...
    'архтп': ['мой онлайн 2020', 'мой онлайн 2018', 'старт', 'мой онлайн 04 2018', 'старт', 'мой разговор 2019', 'супер онлайн 04 2022', 'мой онлайн 04 2022', 'мой онлайн 04 2020', 'мой разговор 06 20 2022', 'везде онлайн 2019', 'мой раговор 04 2022', 'мой онлайн 04 20 2022', 'мой онлайн плюс 2022', 'везде онлайн 04 2020', 'мой онлайн 09 2022', 'интернет для устройств 07 2022', 'черный', 'чёрный', 'мой старт', 'мой онлайн 09 2020', 'мой онлайн\+ 09 2020', 'мой онлайн\+09 2020',, 'мой онлайн\+09_2020', 'мой онлайн плюс 09 2020', 'мой онлайн \+ 09 2020', 'мой онлайн \+09 2022', 'мой онлайн плюс 09 2022', 'мой онлайн \+ 09 2022', 'мой онлайн \+ 10 2023', 'мой онлайн 10_2023', 'мой онлайн 10 2023', 'мой разговор 10 2023', 'мой онлайн \+ 04 2023', 'мой онлайн 04_2023', 'мой онлайн 04 2023', 'мой разговор 04 2023'],
    'говно': ['гавно', 'дермо'],
    'мобильный': ['могильный'],
    'домашний': ['ljvfiybq'],
    ...
    'включите': ['врубите'],
    'онлайн+': ['онлаин плюс', 'онлаин плюс', 'онлайн \+', 'онлаин\+', 'онлаин \+', 'оноайн плюс', 'анлайн плюс'],
    ...
    'опера': ['opera'],
    'мини': ['mini'],
    'интернет для устройств': ['интернет для устройства', 'интернет для устройств', 'интернет для устроиств', 'интрнет для устройств', 'интернеть для устройств'],
    ...
    'фото': ['фотк(\w)?', 'фоту'],
    'работаешь': ['пашешь'],
    'не работает': ['не работки', 'не раьотает', 'не работать', 'неработает'],
