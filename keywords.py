pattern = {
    ...
    'кьюар код': ['qr', 'qr-код', 'qr код', 'кью ар код', 'кью код'],
    ...
    'айпи': ['IP'],
    'впн': ['vpn', 'випиэн'],
    'тариф': ['ТП', 'тараф(.)?', 'тапиф', 'ториф', 'таррив(.)?', 'тарив(.)?', 'тариы', 'твриф', 'тартф', 'тприф', 'таариф', 'трариф', 'тармфы', 'тарий', 'тармф(.)?', 'тариы', 'таиифы'],
    'говно': ['гавно', 'дермо'],
    ...
    'блэк': ['блейк', 'Black'],
    'стоимость': ['Стомость',],
    'абонентская плата': ['АП', 'абонплата', 'Абонн плата', 'Абанентски рлата', 'абон плат(.)?'],
    'разблокируйте': ['Расблоктруйте', 'Black'],
    'сколько': ['скок(.)?', 'сколко'],
    'миа': ['мия', 'мии'],
    'подключить': ['потклучит'],
    'отключить': ['Атклечить'],
