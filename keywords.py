pattern = {
    ...
    'элит': ['elite'],
    'иди на хуй': ['fuck of\w*', 'fuck-of\w*', 'fuck you\w*', 'fuck(\w)?'],
    ...
    'блять': ['бля(\w)?', 'ебал\w*', 'заеба\w*', 'зайба\w*', 'заиба\w*', 'ебат\w*', 'ебалн\w*', 'наебал\w*', 'наибал\w*', 'ябат(\w)?', 'ебат(\w)?', 'ебан(\w)?', 'заебет(\w)?'],
