pattern = {
    ...
    'нано': ['nano'],
    'гигабайт': ['гб(\w)?', 'gb', 'гиг(\w)?', 'гигов', 'гигами', 'гбайт\w*', 'гибогайт(\w)?', 'кигобайт(\w)?', 'гигабвйт(\w)?', 'гегабвйт(\w)?', 'гегабайт(\w)?', 'гигобацт\w*', 'гигаб', 'гега', 'гбт(\w)?', 'гигобайт\w*', 'гигобайт\w*', 'гегобайт\w*', 'ггб', 'гигоьайт(\w)?', 'гигаюайт(\w)?', 'гег\w*', 'гагаб\w*', 'гибайт\w*', 'гишабайт(\w)?'],
